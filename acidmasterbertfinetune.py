# -*- coding: utf-8 -*-
"""AcidMasterBertFineTune.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1A_IVfKJKuYRg8FqtIvPZo1esKHZt8S7l
"""
...
col_names = ["category","text"]
df_acid_train = pd.read_csv("ACIDmaster/customer_training.csv",names=col_names, header=None)
df_acid_train = df_acid_train.iloc[1: , :]
df_acid_train

col_names = ["category","text"]
df_acid_test = pd.read_csv("ACIDmaster/customer_testing.csv",names=col_names, header=None)
df_acid_test = df_acid_test.iloc[1: , :]
df_acid_test

frames= [ df_acid_train,df_acid_test]
df_all = pd.concat(frames ,ignore_index=True)
df_all

df_all["category"].value_counts()

df_counts = df_all["category"].value_counts()
...
model.save_pretrained("model_acid/acid_model")